  ...
  */
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
        ...
        <div className="relative z-10 h-[calc(70vh-80px)] flex flex-col justify-center px-6 md:px-12 lg:px-24">
          <div className="max-w-3xl">
            ...
            >
              ...
              <p className="text-sm text-blue-400 font-medium">ABOUT SMARTINNO ENGINEERING</p>
            </motion.div>
            ...
            <motion.div
              ...
              className="mt-8 flex flex-wrap gap-8 max-w-2xl"
            >
          ...
          {teamMembers.map((member, idx) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 line-clamp-2">{member.bio}</p>
              </div>
            </motion.div>
          ))}
        </div>
      ...
      {/* Contact Section */}
      <div className="px-4 sm:px-6 lg:px-12 py-16 bg-[#0a0f36] text-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.2 }}
              viewport={{ once: true }}
              className="bg-[#131842] p-8 rounded-xl"
            >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      type="text"
                      id="name"
                      className="w-full px-4 py-3 bg-[#1c2254] border border-[#2a325e] rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
