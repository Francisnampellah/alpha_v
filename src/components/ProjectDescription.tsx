...
export default function ProjectDescription({ project, showBackLink = true }: ProjectDescriptionProps) {
  return (
    ...
    >
      ...
      <div className="h-72 bg-gradient-to-r from-#9db0eb to-indigo-600 flex items-center justify-center relative overflow-hidden">
        {project.imageUrl ? (
        ...
        <div className="grid md:grid-cols-2 gap-10 mb-10">
          <div>
            <h2 className="text-xl font-semibold text-gray-900 mb-6 flex items-center">
              <span className="h-8 w-8 rounded-full bg-#9db0eb flex items-center justify-center mr-3">
            ...
            <ul className="space-y-4">
              {project.features.map((feature, index) => (
                ...
                >
                  <svg className="w-5 h-5 text-#9db0eb mr-3 mt-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 rounded-2xl p-6">
                <div className="flex items-center mb-2">
                  <Clock className="h-5 w-5 text-#9db0eb mr-2" />
              ...
              <div className="bg-gray-50 rounded-2xl p-6">
                <div className="flex items-center mb-2">
                  <Users className="h-5 w-5 text-#9db0eb mr-2" />
