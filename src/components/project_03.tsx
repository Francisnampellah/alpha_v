...
const portfolioData = {
  totalValue: "KES 2,456,789.00",
  change: "+KES 45,678.90 (1.9%)",
  assets: [
    {
      id: 1,
...
const assetDetails = {
  ...
  symbol: "SAV",
  description:
    "Your primary savings account with competitive interest rates and flexible withdrawal options. Access your funds anytime through our mobile app.",
  metrics: [
    { name: "Interest Rate", value: "8.5%" },
    { name: "Monthly Interest", value: "KES 1,770.83" },
    { name: "Withdrawal Limit", value: "KES 50,000" },
    { name: "Last Transaction", value: "KES 5,000" },
    { name: "Account Status", value: "Active" },
  ],
  holdings: {
    shares: 250000,
    avgCost: "KES 1,000.00",
    totalCost: "KES 250,000.00",
    marketValue: "KES 250,000.00",
    gain: "KES 17,708.33 (7.1%)",
  },
}
      ...
      <div className="flex flex-col md:flex-row gap-6 items-start justify-center">
        ...
        >
          ...
          <div className="bg-white px-2 py-1.5 flex justify-between items-center border-b border-gray-200">
            <h1 className="font-semibold text-xs">SaccoPro</h1>
            <Briefcase size={12} />
          </div>
