    ...
    <div className="bg-white p-8 md:p-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {isLoading ? (
          // Loading skeletons
          [...Array(3)].map((_, idx) => (
            <div key={idx} className="bg-gray-100 rounded-xl overflow-hidden animate-pulse">
          ...
          teamMembers.slice(0, 3).map((member) => (
            <div key={member.id} className="bg-gray-100 rounded-xl overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-#3798b8 text-sm mb-3">{member.role}</p>
                <p className="text-sm text-gray-600">{member.bio}</p>
                {member.socialLinks && (
                  <div className="mt-4 flex space-x-4">
                    {member.socialLinks.linkedin && (
                      <a href={member.socialLinks.linkedin} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-600">
                    ...
                    {member.socialLinks.twitter && (
                      <a href={member.socialLinks.twitter} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400">
