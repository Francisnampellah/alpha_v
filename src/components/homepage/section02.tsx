...
export default function Section_02() {
    ...
    return (
      <section className="px-4 sm:px-6 lg:px-12 py-16 font-sans bg-white text-black" aria-labelledby="about-smartinno-heading">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-12 border-b border-gray-200 pb-6">
            <div className="flex items-center mb-4 sm:mb-0">
              ...
              <div>
                <h2 id="about-smartinno-heading" className="text-2xl font-bold">About SMARTiNNO</h2>
                <p className="text-sm text-gray-600">Just the board, the streets, & your trick.</p>
              </div>
            </div>
            <button 
